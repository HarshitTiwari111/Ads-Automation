  ...
  async runDaily() {
    ...
    for (const account of accounts) {
      try {
        ...
        console.log(`[REPORT] Daily report generated for ${account.accountName}`);
      } catch (error) {
        console.error(`[REPORT] Error generating daily report for ${account._id}:`, error.message);
      }
    }
  },
  ...
  async runWeekly() {
    ...
    for (const account of accounts) {
      try {
        ...
        console.log(`[REPORT] Weekly report generated for ${account.accountName}`);
      } catch (error) {
        console.error(`[REPORT] Error generating weekly report for ${account._id}:`, error.message);
      }
    }
  },
